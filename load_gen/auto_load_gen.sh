...
do
  #Uploads
  timeout $time_out taskset -c 3,4,5,6 ./a.out 10.129.23.200 3212 $i 1
  ...
  timeout $time_out taskset -c 3,4,5,6 ./a.out 10.129.23.200 3212 $i 2
...
for i in $(seq 10 5 400);
  ...
  timeout $time_out taskset -c 3,4,5,6  ./a.out 10.129.23.200 3212 $i 3
